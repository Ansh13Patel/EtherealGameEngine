...
namespace EtherealEditor.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\EtherealEditor\";
        ...
        private static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}/.ethereal/Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}/.ethereal/Screenshot.png");
                        _projects.Add(project);
                    }
                }
            }
